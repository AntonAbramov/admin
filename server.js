...
app.get('/iwatch/:model', function (req, res) {
  console.log('I reveived a GET request');
  var dbName = 'iwatch' + req.params.model;
  db[dbName].find().sort({'idx' : 1}, function (err, docs) {
    if (err) throw err;
    console.log(docs);
    res.json(docs);
...
app.post('/iwatch/:model', function (req, res) {
  console.log(req.body);
  var dbName = 'iwatch' + req.params.model;
  db[dbName].insert(req.body, function (err, doc) {
    res.json(doc);
...
app.delete('/iwatch/:model/:id', function (req, res) {
  var id = req.params.id;
  var dbName = 'iwatch' + req.params.model;
  db[dbName].remove({_id: mongojs.ObjectId(id)}, function (err, doc) {
    res.json(doc);
...
app.get('/iwatch/:model/:id', function (req, res) {
  var id = req.params.id;
  var dbName = 'iwatch' + req.params.model;
  db[dbName].findOne({_id: mongojs.ObjectId(id)}, function (err, doc){
    res.json(doc);
...
app.put('/iwatch/:model/:id', function (req, res) {
  var id = req.params.id;
  var dbName = 'iwatch' + req.params.model;
  db[dbName].findAndModify({query:{_id: mongojs.ObjectId(id)},
    update: {$set: {
